-- Active: 1761242575631@@127.0.0.1@5432@project_db@public
...
-- Find the difference between the hire date of the first employee hired and every other employees partitioned by department
...
-- Return the first salary for different departments Order by the salary in descending order
SELECT
    *,
...
-- Return the first salary for different departments Order by the first_name in ascending order
SELECT
    *,
    first_salary - salary AS salary_difference
FROM (
